      ...
      <div className="container lg:grid lg:grid-cols-2 items-center lg:gap-10">
        <div>
          ...
          <p className="text-zinc-400 mb-4 lg:mb-6 text-lg">
            A Passionate Sophomore Developer Focused on Web Development. Crafting Innovative Solutions, One Line of Code at a Time.
          </p>
          <div className="lg:mb-6 mb-4">
            <SocialLinks />
          </div>
          <div className="flex items-center gap-3">
            <a href='/Akash_resume.pdf' download="Akash_resume.pdf"><ButtonPrimary label={"Download CV"} icon="download" /></a>
            <ButtonOutline
              href="#about"
              label={"Scroll Down"}
              icon="arrow_downward"
